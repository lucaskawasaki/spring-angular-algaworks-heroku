...
public class PessoaController {	
	...
	@GetMapping
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_PESSOA')")
	public Page<Pessoa> pesquisarPessoaPorNome(@RequestParam(required = false, defaultValue = "") String nome, Pageable pageable){
		return pessoaService.acharPessoaPorNome(nome, pageable);
	}
